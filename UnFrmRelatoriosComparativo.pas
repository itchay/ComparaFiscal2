...
procedure TFrmRelatoriosComparativo.BtnATFAdicionarClick(Sender: TObject);
  ...
  begin
    ...
    begin
      auxATF := lListaATF[i];
      //verificar se o ATF já foi inserido na lista
      flag:= false;
      ...
      //caso não exista na lista adiciona o arquivo
      if flag = false then
        result.Add(auxATF);
    end;
  end;
...
begin
  ...
  //remove resultados de devolução propria (emitente e destinatario são o mesmo CNPJ)
  ...
  try
    ...
    begin
      ...
      begin
        ...
        //preenche informações do relatorio e imprime
        ...
        begin
          ...
          ppLblSubTituloRel.Caption := 'Quantidade de Chave(s) de Acesso não encontrada(s) no .txt SPED: ';
        ...
        begin
          ...
          ppLblSubTituloRelSPED.Caption := 'Quantidade de Chave(s) de Acesso não encontrada(s) no .txt ATF :';
...
procedure TFrmRelatoriosComparativo.BtnSPEDAdicionarClick(Sender: TObject);
  ...
  begin
    ...
    begin
      ...
      //verificar se o SPED já foi inserido na lista
      flag:= false;
