...
begin
  ...
  //verifica se o periodo do arquivo já foi inserido no banco de dados
  try
    with query do
    begin
...
//arquivo ATF não possui data de emissao bem definida, então retorna essa informação baseada nas notas
