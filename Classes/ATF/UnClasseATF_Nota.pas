    ...
    begin
      ...
      begin
        ...
        begin
          ...
          with auxNota do
          begin
            sCHAVE_ACESSO := FieldByName('CHAVE_ACESSO').AsString;
            sNOME_RAZAO_SOCIAL_DEST := FieldByName('NOME_RAZAO_SOCIAL_DEST').AsString;
            sCPF_CNPJ_DEST := FieldByName('CPF_CNPJ_DEST').AsString;
            sINSCRICAO_ESTADUAL_DEST := FieldByName('INSCRICAO_ESTADUAL_DEST').AsString;
            sPLACA_VEICULO_REBOQUE := FieldByName('PLACA_VEICULO_REBOQUE').AsString;
            sUF_PLACA := FieldByName('UF_PLACA').AsString;
            sNOME_TRANSPORTADORA := FieldByName('NOME_TRANSPORTADORA').AsString;
            sINSCRICAO_ESTADUAL_TRANSP := FieldByName('INSCRICAO_ESTADUAL_TRANSP').AsString;
            sCPF_CNPJ_TRANSPORTADORA := FieldByName('CPF_CNPJ_TRANSPORTADORA').AsString;
            sIP_EMITENTE := FieldByName('IP_EMITENTE').AsString;
            sPORTA_CONEXAO_ORIGEM := FieldByName('PORTA_CONEXAO_ORIGEM').AsString;
            sSITUACAO := FieldByName('SITUACAO').AsString;
            sTIPO_OPERACAO := FieldByName('TIPO_OPERACAO').AsString;
            sUF_DEST := FieldByName('UF_DEST').AsString;
            sMODALIDADE_FRETE := FieldByName('MODALIDADE_FRETE').AsString;
            iID := FieldByName('ID_NOTA').AsInteger;
            iNUM_DOC := FieldByName('NUM_DOC').AsInteger;
            iSERIE := FieldByName('SERIE').AsInteger;
            fVALOR_TOTAL_NOTA := FieldByName('VALOR_TOTAL_NOTA').AsFloat;
            fBASE_ICMS := FieldByName('BASE_ICMS').AsFloat;
            fVALOR_ICMS := FieldByName('VALOR_ICMS').AsFloat;
            fBASE_ICMS_ST := FieldByName('BASE_ICMS_ST').AsFloat;
            fVALOR_ICMS_SUBSTITUICAO := FieldByName('VALOR_ICMS_SUBSTITUICAO').AsFloat;
            fVALOR_TOTAL_DOS_PRODUTOS := FieldByName('VALOR_TOTAL_DOS_PRODUTOS').AsFloat;
            fVALOR_FRETE := FieldByName('VALOR_FRETE').AsFloat;
            fVALOR_SEGURO := FieldByName('VALOR_SEGURO').AsFloat;
            fVALOR_DESCONTO := FieldByName('VALOR_DESCONTO').AsFloat;
            fVALOR_OUTRAS_DESPESAS := FieldByName('VALOR_OUTRAS_DESPESAS').AsFloat;
            fVALOR_IPI := FieldByName('VALOR_IPI').AsFloat;
            fVALOR_TOTAL_ICMS_UF_DEST := FieldByName('VALOR_TOTAL_ICMS_UF_DEST').AsFloat;
            fVALOR_TOTAL_ICMS_UF_REMET := FieldByName('VALOR_TOTAL_ICMS_UF_REMET').AsFloat;
            fVALOR_ICMS_FCP_UF_DEST := FieldByName('VALOR_ICMS_FCP_UF_DEST').AsFloat;
            daDATA_EMISSAO := FieldByName('DATA_EMISSAO').AsDatetime;
            tHORA_EMISSAO := FieldByName('HORA_EMISSAO').AsDatetime;
            dtDATA_HORA_CONEXAO_ORIGEM := FieldByName('DATA_HORA_CONEXAO_ORIGEM').AsDatetime;
          end;
