object FrmListarATF: TFrmListarATF
  Left = 0
  Top = 0
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'Listar - Arquivos ATF'
  ClientHeight = 481
  ClientWidth = 856
  Color = clBtnFace
  ...
  object PnlInfoDoc: TPanel
    ...
    Height = 453
    TabOrder = 0
    object LblQtdeATFEncontrados: TLabel
      Left = 10
      Top = 434
      Width = 9
      Height = 13
    ...
    object LblTotalATFEncontrados: TLabel
      Left = 248
      Top = 433
      Width = 9
      Height = 13
    ...
    object StgATF: TStringGrid
      ...
      TabOrder = 3
      OnDblClick = StgATFDblClick
      OnKeyDown = StgATFKeyDown
      ColWidths = (
        25
        90
        110
  ...
  object PopupMenu1: TPopupMenu
    Left = 36
    Top = 15
    object DeletarATF: TMenuItem
      Caption = 'Deletar/Excluir'
      ShortCut = 46
      OnClick = DeletarATFClick
    end
  end
end
