  ...
  begin
    ...
    begin
      ...
      if auxATF.ListaNotas.Count <> 0 then
        StgATF.RowCount:= auxATF.ListaNotas.Count + 2;

      linhasOcultadas:= 0;
      auxRegistrosSelecionados := auxATF.ListaNotas.Count;
      for i:= 0 to auxRegistrosSelecionados - 1 do
      begin
        //filtra os resultados na tela
        if RadioTipoNF.ItemIndex = _TIPO_NF_ENTRADA then
        ...
        Cells[1, i + 2 - linhasOcultadas]:= IntToStr(auxATF.ListaNotas[i].SERIE);
        Cells[2, i + 2 - linhasOcultadas]:= IntToStr(auxATF.ListaNotas[i].Num_Doc);
        Cells[3, i + 2 - linhasOcultadas]:= auxATF.ListaNotas[i].CHAVE_ACESSO;
        Cells[4, i + 2 - linhasOcultadas]:= FormatDateTime('dd/mm/yyyy', auxATF.ListaNotas[i].DATA_EMISSAO);
        ...
        Cells[6, i + 2 - linhasOcultadas]:= retiraCaractere('.',FloatToStrF(auxATF.ListaNotas[i].VALOR_TOTAL_NOTA, ffnumber, 15, 02));
